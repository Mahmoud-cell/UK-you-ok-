 <?php
  ...
  ?>  
<h3>Your Account</h3>
  <form  class="form-horizontal span6" action="index.php?action=edit" onsubmit="return personalInfo();" name="personal" method="POST" enctype="multipart/form-data"> 
          <div class="row">
             <div class="col-lg-6">
              ...
              <div class="form-group">
                <div class="col-md-12">
                  ...
                  <div class="col-md-8">
                    ...
                    <button type="submit" name="save"  value="Save" class="submit btn btn-primary btn-lg"><a href="index.php"></button>
