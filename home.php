              ...
              <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                      ...
                      <h1><?php  echo $result->OWNERNAME; ?></h1>
                      <h2><?php  echo $result->PRODISPRICE; ?> LE</h2>
                    ...
                    <div class="product-overlay">
                      <div class="overlay-content">
                        <h2><?php  echo $result->PRODISPRICE; ?> LE</h2>
                        <p><?php  echo    $result->PRODESC; ?></p>
                       <button type="shsubmit" name="btnorder" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</button>
                      </div>
                    </div>
                </div>
                <div class="choose">
