...
<head>
  ...
  <link href="css/responsive.css" rel="stylesheet">
    <link rel="icon" href="images/home/plus.png">
    <!--[if lt IE 9]>
...
<body style="background-color:white" onload="totalprice()" >
  ...
  <header id="header"><!--header-->
          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills" >
                ...
                <li><a href="#"><i class="fa fa-envelope"></i> youok_uk@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-md-4 clearfix">
            <div class="logo pull-left">
              <a href="#"><img src="images/home/logo.png" alt="" style="width:100%" /></a>
            </div> 
          </div>
    ...
    <div class="footer-widget">
      <div class="container">
        <p style="color: #FFF">You can modify this section using your own personal information</p>
        <div class="row">
          <div class="col-sm-3">
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <p class="pull-left">Modified by <span><a href="https://bit.ly/2LPn9Wu">MKM</a></span></p>
        </div>
      </div>
    </div>
