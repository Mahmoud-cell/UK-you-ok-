...
?>
                          ...
                          <tr class="cart_menu"> 
                             ...
                             <?php
                              ...
                              if (!empty($_SESSION['gcCart'])){ 
                                ...
                                <tr>
                                  <td>  
                                    <img src="<?php echo web_root. 'admin/products/'.$result->IMAGES; ?>"  onload="  totalprice() " width="100px" height="100px"> 
                                  <br/> 
                                        <?php    
             ...
             ';
                                  ...
                                  <td>
                                    ...
                                    <?php echo  $result->PRODISPRICE ; ?> LE
                                  </td>
                        ...
                        <h3 align="right"> Total <span id="sum">0</span> LE</h3> 
    </div>
  </div>  
